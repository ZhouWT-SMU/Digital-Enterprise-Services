...
class ChatControllerTest {
    ...
    void testSendMessage_Success() {
        ...
        // 模拟服务层方法
        when(difyChatFlowService.sendMessage(message, userId)).thenReturn(mockResponse);
        ...
        // 验证服务层方法被调用
        verify(difyChatFlowService, times(1)).sendMessage(message, userId);
    }
    ...
    void testSendMessage_Failure() {
        ...
        // 模拟服务层抛出异常
        when(difyChatFlowService.sendMessage(message, userId))
